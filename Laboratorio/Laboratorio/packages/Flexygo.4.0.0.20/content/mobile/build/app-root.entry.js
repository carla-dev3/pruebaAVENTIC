...
import { W as Webapi, a as storage } from './webapi-dc144dc6.js';
import { c as cordova, I as IonicNativePlugin, i as flxPush, C as ConftokenProvider, u as util, f as flxSync, m as msg } from './messages-bded0bf9.js';
...
const AppRoot = class {
    ...
    async getProfileInfo() {
        ...
        if (token.profile && token.profile[0]) {
            this.profile = token.profile[0];
    ...
    render() {
        return ([
            h("ion-app", null, h("ion-menu", { "content-id": "menu-content" }, h("ion-header", null, h("ion-toolbar", { color: "header" }, h("ion-title", null, util.translate('menu.menu')))), h("ion-content", null, h("ion-list", null, this.profile ?
                ...
                :
                    h("div", null), h("ion-item", { onClick: () => nav.goHome() }, h("ion-label", null, util.translate('menu.home')), h("ion-icon", { name: "home" })), this.loadMenusHTML(), h("ion-item", { onClick: () => { jquery('#syncMenu').toggle(250); } }, h("ion-label", null, util.translate('menu.sync'), h("ion-icon", { name: "alert-circle", color: "danger", class: "stack sendError hide" })), h("ion-icon", { name: "wifi" })), h("ion-item-group", { id: "syncMenu", class: "hidden ion-padding-start" }, h("ion-item", { onClick: () => flxSync.syncData() }, h("ion-label", null, util.translate('sync.refresh')), h("ion-icon", { name: "cloud-download" })), h("ion-item", { onClick: () => { flxSync.sendData(); nav.goHome(); } }, h("ion-label", null, util.translate('sync.send'), h("ion-icon", { name: "alert-circle", color: "danger", class: "stack sendError hide" })), h("ion-icon", { name: "repeat" })), h("ion-item", { onClick: () => nav.goSync() }, h("ion-label", null, util.translate('menu.syncMore')), h("ion-icon", { name: "ellipsis-horizontal-outline" }))), !this.profile ?
