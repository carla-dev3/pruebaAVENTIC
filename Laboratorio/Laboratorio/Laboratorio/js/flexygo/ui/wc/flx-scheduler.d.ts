    ...
    */
    class FlxScheduler extends HTMLElement {
       ...
       */
        ...
        * @method render
        */
        render(options: string[], activeMode: string, maxTime: string, minTime: string, onClickEvent: string, allDaySlot: string, slotDuration: string, pageType: string, target: string, eventLimit: boolean, disableResize: boolean, disableDrag: boolean): void;
        /**
       * Check Objects.
