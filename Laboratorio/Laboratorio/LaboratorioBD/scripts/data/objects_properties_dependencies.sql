...
USING (VALUES
  (N'Articulo',N'IdFamilia',N'IdArticulo',2,1,NULL,N'Select CONCAT(''{{P_DescPrefijoFam}}'', IsNull(Max(Cast(substring(IdArticulo,4, 4) As Int)),0) + 1) As Num  From Articulos Where Left(IdArticulo,3)=''{{P_DescPrefijoFam}}'' AND Right(IdArticulo,0)=''''  AND ISNumeric(substring(IdArticulo,4, 4))=1 AND Len(IdArticulo)=7',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Articulo',N'IdFamilia',N'P_DescPrefijoFam',1,1,NULL,N'Select ProductoPrefijo From Articulos_Familias Where IdFamilia=''{{IdFamilia}}''',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Articulo',N'IdFamilia',N'PDesc_EsFormula',3,1,NULL,N'SELECT P_Formula FROM Conf_Art_Familias WHERE IdFamilia = {{IdFamilia}}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Articulo_Metodos',N'P_Conservacion',N'P_DescripConservacion',1,1,NULL,N'SELECT Descrip FROM Pers_Articulos_Conservacion WHERE IdConservacion = {{P_Conservacion}}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Articulo_Metodos',N'P_ControlAnalitico',N'P_DescripControlAnalitico',1,1,NULL,N'SELECT Descrip FROM Pers_Articulos_Control_Analitico WHERE IdControlAnalitico = {{P_ControlAnalitico}}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Articulo_Metodos',N'P_ControlCalidad',N'P_DescripControlCalidad',1,1,NULL,N'SELECT Descrip FROM Pers_Articulos_Control_Calidad WHERE IdControlCalidad = {{P_ControlCalidad}}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Articulo_Metodos',N'P_DuracionTratamiento',N'P_DescripDurTratamiento',1,1,NULL,N'SELECT Descrip FROM Pers_Articulos_Duracion_Tratamiento WHERE IdDuracionTratamiento = {{P_DuracionTratamiento}}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Articulo_Metodos',N'P_Posologia',N'P_DescripPosologia',1,1,NULL,N'SELECT Descrip FROM Pers_Articulos_Posologia WHERE IdPosologia = {{P_Posologia}}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Articulo_Metodos',N'P_Utillaje',N'P_DescripUtillaje',1,1,NULL,N'SELECT Descrip FROM Pers_Articulos_Utillaje WHERE IdUtillaje = {{P_Utillaje}}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Objeto_Imagenes',N'NombreFichero',N'Descrip',1,1,NULL,N'SELECT {{NombreFichero}}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Precios_Clientes_Articulos',N'IdLista',N'Desc_Lista',1,1,NULL,N'select Descrip from Listas_Precios_Cli WHERE IdLista = {{IdLista}}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Precios_Clientes_Articulos',N'IdLista',N'IdArticulo',2,1,NULL,N'SELECT IdArticulo FROM Articulos WHERE IdArticulo = {{IdArticulo}}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
 ,(N'Precios_Prov_Articulos',N'IdLista',N'DescLista',1,1,NULL,N'SELECT Descrip FROM Listas_Precios_Prov WHERE IdLista = {{IdLista}}',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,N'DataConnectionString',0,1)
